...
### TTB COLA Links
When a TTB_ID is provided, a clickable label emoji (🏷️) will appear next to the batch text in the table that opens the official TTB COLA approval page. To find TTB IDs:
